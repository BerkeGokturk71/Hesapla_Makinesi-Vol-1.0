...
entry2 = Entry(textvariable=StringVar(),show="*",width=30)
write2 = Label(text="Password")
write2.pack()
entry2.pack()
...
def buton():
    ...
    if mail == 'admin' and psw =='3131':
       messagebox.showinfo("Giriş Yapıldı","Başarıyla Giriş Yaptınız :)")
       tk.destroy()

    else:
        messagebox.showwarning("Hata","Yanlış Kullanıcı Adı ya da Şifre")
